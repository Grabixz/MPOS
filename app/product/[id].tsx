    ...
    <View className='flex-1 bg-white'>
        <ScrollView contentContainerStyle={{paddingBottom: 100}}>
            ...
            <View className='relative h-[450px] bg-gray-100 mb-6'>
                <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} scrollEventThrottle={16} onScroll={(e) => {const slide = Math.ceil(e.nativeEvent.contentOffset.x / e.nativeEvent.layoutMeasurement.width);setActiveImageIndex(slide)}}>
        ...
        <View className='absolute bottom-0 left-0 flex-row right-0 p-4 bg-white border-t border-gray-100'>
            <TouchableOpacity onPress={handleAddToCart} className='w-4/5 bg-primary py-4 rounded-full items-center shadow-lg flex-row jusitfy-center'>
            ...
            <TouchableOpacity onPress={() => router.push('/(tabs)/cart')} className='w-1/5 py-3 flex-row justify-center relative'>
                ...
                <View className='absolute top-2 right-4 size-4 z-10 bg-black rounded-full jusitify-center items-center'>
