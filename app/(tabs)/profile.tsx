      ...
      contentContainerStyle={!user ? {flex: 1, justifyContent: "center", alignItems: "center"} : {paddingTop: 16}} >
        {!user ? (
          ...
          <View className='items-center w-full'>
            ...
            <Text className='text-primary font-bold text-al mb-2'>Guest User</Text>
            <Text className='text-secondary text-base mb-8 text-center w-3/4 px-4'>Login in to view your profile, orders, and addresses.</Text>
